...
class AuditWorker(QThread):
    ...
    def run(self):
        # We need an event loop for the async audit
...
class SecurityDashboardDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("🛡️ Cyber Security Dashboard")
    ...
    def _init_ui(self):
        ...
        self.score_label.setStyleSheet("font-weight: bold; color: #a6e3a1; font-size: 24px;")
    ...
    def _run_audit(self):
        ...
        self.score_label.setStyleSheet("font-weight: bold; color: #f9e2af; font-size: 24px;")
    ...
    def _on_audit_complete(self, result: dict):
        ...
        self.score_label.setStyleSheet(f"font-weight: bold; color: {color}; font-size: 24px;")
        ...
        for i, finding in enumerate(findings):
            ...
            heal_btn.setStyleSheet("color: #f38ba8;")
