...
class HardwareTelemetryDaemon:
    ...
    def __init__(self, event_bus: EventBus, ollama_url: str = "http://localhost:11434"):
        ...
        # Keep track of latest telemetry state for synchronous querying
    ...
    async def _monitor_loop(self) -> None:
        ...
        while self._running:
            try:
                ...
                # 2. Ollama VRAM footprint via /api/ps
                ...
                if is_warning:
                    ...
                    self.event_bus.publish(
                        Event(
                            event_type="hardware.resource_warning",
                            source="HardwareTelemetryDaemon",
