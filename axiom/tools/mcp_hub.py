...
class MCPHub:
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "bridged_tools_count": len(self.active_tools)
        }
    ...
    def connect_sse(self, name: str, url: str):
        try:
            ...
            # Start client asynchronously and wait for handshake
            future = concurrent.futures.Future()
            ...
            async def _init_client():
                try:
                    ...
                    init_req = {
                        ...
                        "id": self._next_id(),
                        "method": "initialize",
                        "params": {"protocolVersion": "2024-11-05", "capabilities": {}, "clientInfo": {"name": "axiom", "version": "2.0"}}
                    }
            ...
            future.result(timeout=10.0) # Wait up to 10 seconds for init
